...
public class Tags extends BlockTagsProvider {
    ...
    public Tags( DataGenerator generator, ExistingFileHelper helper ) {
        super( generator, WallpapercraftSlabs.MODID, helper );
    }
    ...
    protected void addTags() {
        ...
        for ( final IDecorativeBlock b : ModBlocks.SLABS_BLOCKS.values() ) {

            final Block block = ForgeRegistries.BLOCKS.getValue( WallpapercraftSlabs.getId( b.getNameForRegistry() ) );
